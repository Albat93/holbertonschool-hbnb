...
async function fetchPlaces(token) {
  try {
    ...
    if (response.ok) {
      ...
      console.error(
        "Erreur lors de la récupération des places :",
        response.statusText
      );
  ...
  return [
    {
      ...
      price: 100,
      description:
        "Une magnifique maison en bord de mer, idéale pour des vacances d'été inoubliables.",
    ...
    },
    {
      ...
      price: 75,
      description:
        "Un chalet chaleureux niché au cœur des bois, parfait pour se ressourcer.",
    ...
    },
    {
      ...
      price: 150,
      description:
        "Appartement moderne en centre-ville, proche de toutes commodités.",
    ...
    },
    {
      ...
      price: 250,
      description:
        "Une villa spacieuse et luxueuse avec piscine, idéale pour des séjours haut de gamme.",
...
function loadPlaceDetails() {
  ...
  document.getElementById("place-name").textContent =
    place.name || "Nom non défini";
  document.getElementById("place-host").textContent = `Host: ${
    place.host || "Non défini"
  }`;
  document.getElementById("place-price").textContent = `Price: $${
    place.price || "N/A"
  } per night`;
  ...
  document.getElementById("place-amenities").textContent = `Amenities: ${
    place.amenities || "Aucune"
  }`;
  const placeImg = document.getElementById("place-image");
  if (placeImg) {
    placeImg.src =
      place.image || "https://via.placeholder.com/800x500?text=No+Image";
  }
}
